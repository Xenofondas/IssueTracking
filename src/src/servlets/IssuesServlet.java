...
public class IssuesServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// TemplateEngineUtil.getTemplateEngine(request.getServletContext());
		...
		if (request.getParameter("action") != null) {
			...
			Issue issue = new Issue(null, request.getParameter("title"), request.getParameter("description"),
					request.getParameter("category"), dtf.format(now), dtf.format(now),
					session.getAttribute("username").toString(), request.getParameter("status"),
